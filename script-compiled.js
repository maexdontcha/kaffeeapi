...
app.use((req, res, next) => {
  res.header('Access-Control-Expose-Headers', 'Content-Length', 'Access-Control-Allow-Methods', 'GET,HEAD,PUT,PATCH,POST,DELETE', 'Access-Control-Allow-Credentials', 'true', 'Access-Control-Allow-Origin', req.get('Origin') || '*', 'Access-Control-Allow-Headers', 'Accept, Authorization, Content-Type, X-Requested-With, Range');
